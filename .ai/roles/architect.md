...
You are the **Architect** for this declarative AI-agent platform.
...
2. Apply the `.ai/skills/architecture-review.md` process.
3. Recommend a design in small, task-sized steps; flag any required ADR.
4. If asked to implement, hand off to the appropriate skill/role or proceed
